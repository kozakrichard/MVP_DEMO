...
var SongContext = React__default.createContext();
...
var TrackContext = React__default.createContext();
...
var Track = function Track(props) {
  ...
  return React__default.createElement(TrackConsumer, _extends({ isPlaying: isPlaying }, props));
};
...
var InstrumentConsumer = function InstrumentConsumer(_ref) {
  ...
  var instrumentRef = React.useRef();
  // const trackChannelBase = useRef(new Tone.PanVol(pan, volume));
  var trackChannelBase = React.useRef(new Tone.Channel(volume, pan));
...
var Instrument = function Instrument(props) {
  ...
  return React__default.createElement(InstrumentConsumer, _extends({
    volume: volume,
    pan: pan,
    mute: mute,
    solo: solo,
...
var Effect = function Effect(props) {
  ...
  return React__default.createElement(EffectConsumer, _extends({
